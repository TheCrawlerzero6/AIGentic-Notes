...
class _AudioRecorderWidgetState extends State<AudioRecorderWidget> {
  ...
  Future<void> _startRecording() async {
    ...
    try {
      ...
      _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
        ...
        if (_secondsElapsed >= FeatureFlags.MAX_AUDIO_DURATION_SECONDS) {
          _stopRecording();
        }
      });
  ...
  Widget _buildIdleUI() {
    return Column(
      children: [
        ...
        Text(
          'Máximo: ${FeatureFlags.MAX_AUDIO_DURATION_SECONDS} segundos',
          style: TextStyle(
            fontSize: 12,
  ...
  Widget _buildRecordingUI() {
    final progress = _secondsElapsed / FeatureFlags.MAX_AUDIO_DURATION_SECONDS;
